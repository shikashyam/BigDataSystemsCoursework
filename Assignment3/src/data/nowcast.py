...
def visualize_result(models,x_test,y_test,idx,labels):
    FS = gcsfs.GCSFileSystem(project="sevir-data-pipeline")
    ...
    fig.savefig('/Users/sairaghavendraviravalli/Desktop/Projects/neurips-2020-sevir-master-3/src/data/sample.png')   # save the figure to file
...
def plot_results(testing_file,idxin):
    ...
    visualize_result([gan_model],x_test,y_test,idx,labels=['cGAN+MAE'])
